...
-- Homework 7
transB (Compare Leq ie1 ie2) = transA ie2 ++ transA ie1 ++ [Ilt] ++ [Ni]
-- Homework 7
transB (Compare Geq ie1 ie2) = transA ie1 ++ transA ie2 ++ [Ilt] ++ [Ni]
...
transC (Repeat cmd be) 
    = let tst = transB be
    	  body = transC cmd
      in body ++ tst ++ [Jz (-(1+codeLen body + codeLen tst))]
