...
nandify (p :|: q)   =  nandify (nandify (p :#: p) :#: nandify (q :#: q))
nandify (p :&: q)   =  nandify (nandify (p :#: q) :#: nandify (p :#: q))
nandify (p :->: q)  =  nandify p :#: nandify ( q :#: q)
nandify (p :<->: q) =  nandify ((p :->: q) :&: (q :->: p)) -- a gift
nandify (p :#: q)   =  (nandify p :#: nandify q)
